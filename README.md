...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=220&color=0:7F00FF,35:00C2FF,70:FF00D4,100:FF6A00&text=ANSHIKA%20BAJPAI&fontSize=48&fontColor=ffffff&fontAlignY=38&desc=Machine%20Learning%20%7C%20Software%20Engineering%20%7C%20Data%20Systems&descAlignY=58" />

<img src="https://readme-typing-svg.demolab.com?font=Space+Mono&weight=700&size=24&duration=2600&pause=700&color=00F7FF&center=true&vCenter=true&width=900&lines=Building+AI+systems+that+ship;Turning+slow+pipelines+into+fast+ones;Mixing+ML+research+with+production+engineering;Medical+imaging+%2B+RAG+%2B+data+systems" alt="Typing SVG" />
...
```mermaid
flowchart LR
    A[Messy problem] --> B[Ask the right questions]
    B --> C[Design the system]
    C --> D[Build the pipeline]
    D --> E[Measure everything]
    E --> F[Ship improvements]
    F --> G[Repeat]
```
...
<img src="https://skillicons.dev/icons?i=python,java,cpp,c,postgres,mysql,mongodb,redis,fastapi,spring,docker,kubernetes,gcp,azure,git,github,linux,pytorch,tensorflow&theme=dark" />
...
![MONAI](https://img.shields.io/badge/MONAI-1a1a1a?style=for-the-badge&logoColor=white&labelColor=1a1a1a&color=FF00D4)
![LLMs](https://img.shields.io/badge/LLMs-1a1a1a?style=for-the-badge&logo=openai&logoColor=00F7FF)
![RAG](https://img.shields.io/badge/RAG-1a1a1a?style=for-the-badge&logoColor=white&color=7F00FF)
![Computer%20Vision](https://img.shields.io/badge/Computer%20Vision-1a1a1a?style=for-the-badge&logoColor=white&color=FF6A00)
![NLP](https://img.shields.io/badge/NLP-1a1a1a?style=for-the-badge&logoColor=white&color=00C2FF)

### backend / cloud / systems
![FastAPI](https://img.shields.io/badge/FastAPI-0f172a?style=for-the-badge&logo=fastapi&logoColor=00F7FF)
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-0f172a?style=for-the-badge&logo=githubactions&logoColor=00E5FF)
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=120&section=footer&color=0:7F00FF,35:00C2FF,70:FF00D4,100:FF6A00" />
